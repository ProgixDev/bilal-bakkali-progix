  ...
  return (
    <div className={styles.root} data-devis-root>
      ...
      <main className={styles.main}>
        ...
        <SignatureSection />
        <Footer
          heading="Voyons clair dans Laap"
          text="Un montant ferme de 1 000 €, une semaine, un rapport complet qui hiérarchise chaque constat et chiffre chaque correction. Il ne reste qu’à signer."
        />
      </main>
      <ScrollReveal />
    </div>
